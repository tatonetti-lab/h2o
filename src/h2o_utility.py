...
def estimate_h2o(h2r_results, ci = 95., pcutoff=0.05, edge_eps=1e-9, denoise_eps=0.05, error_reporting=True, run_kstest=False):
    ...
    if num_significant < 30 and error_reporting:
    ...
    if run_kstest:
        ...
        ksstat, kspval = stats.kstest(x, 'norm')
    ...
    if run_kstest:
        return h2o, h2olo, h2ohi, solarerr, solarpval, num_converged, num_significant, posa, ksstat, kspval
